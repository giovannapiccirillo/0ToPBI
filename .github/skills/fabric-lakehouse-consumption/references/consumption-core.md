<!-- Copiato integralmente da microsoft/skills-for-fabric common/SQLDW-CONSUMPTION-CORE.md.
     Contenuto invariato: copre anche Warehouse/DW e sicurezza/performance non
     usate da questo progetto, ma è la fonte di riferimento più completa per
     la superficie T-SQL supportata e i gotcha del Lakehouse SQL endpoint. -->
