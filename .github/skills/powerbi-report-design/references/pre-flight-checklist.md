...
- [ ] **Single source of truth** — if writing files, the report-builder design
      output contains the user-readable report spec and exactly one fenced
      `yaml` block beginning with `Design Brief:`.
