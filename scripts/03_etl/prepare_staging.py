"""Script generico e parametrico per la fase 3 (ETL) del progetto.
...
def prepare_staging(
    ...
    # Il log è parte dell'output obbligatorio della fase 3: viene scritto
...
NON e' un errore ne' un motivo per saltare la fase 3):
