# Valida output/<Workdir>/data-analysis.md contro il template ufficiale della fase 1.5 (Analisi Dati).
...
# Gate obbligatorio: la fase 1.5 (Analisi Dati) non è conclusa finché questo script non esce con 0.
#
